      ...
      <div className={`flex items-center gap-2 rounded-[20px] border px-3 py-2 shadow-2xl backdrop-blur-2xl ${containerCls}`}>
        <div className="relative flex flex-col items-center">
          ...
          <button onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}
            onClick={onOpenSettings} onContextMenu={handleContextMenu}
