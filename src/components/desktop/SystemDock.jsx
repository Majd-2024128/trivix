...
export default function SystemDock({ onOpenSettings, isSettingsOpen, onCloseSettings }) {
  ...
  return (
    <div className="fixed bottom-3 left-3 z-50">
      <div className="flex items-center rounded-[20px] border border-white/15 bg-white/[0.18] px-3 py-2 shadow-2xl shadow-black/25 backdrop-blur-2xl">
        <div className="relative flex flex-col items-center">
          ...
          {/* No magnification - just simple click */}
          <button
          ...
          >
            <img src={systemIcon} alt="System" className="h-full w-full object-cover" />
          </button>
