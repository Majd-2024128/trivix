  ...
  return (
    <div className="fixed inset-0 z-[999] overflow-hidden font-space text-white" style={{ backgroundImage: wallpaper, backgroundSize: fit, backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundColor: "#030814" }}>
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        <div className="tabular-nums leading-none drop-shadow-2xl" style={{ fontSize: clockSize, fontWeight: style === "thin" ? 300 : 800, letterSpacing: 0 }}>
        ...
        ) : <div className="mt-24 text-sm text-white/65">Press Space to unlock</div>}
      </div>
